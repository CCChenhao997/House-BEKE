...
parser.add_argument('--cv_type', default='StratifiedKFold', type=str, choices=['StratifiedKFold', 'KFold', 'GroupKFold'])
...
parser.add_argument('--criterion', default=None, type=str, help='loss choice', choices=['focalloss', 'ghmc', 'diceloss', 'bce'])
